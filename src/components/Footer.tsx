...
export const Footer: React.FC = () => {
  return (
    <footer id="contact" className="relative bg-card/50 border-t border-white/5">
      {/* Contact Section */}
      <div className="container mx-auto px-6 py-20">
        <div className="grid lg:grid-cols-2 gap-16">
          {/* Contact Info */}
          <ScrollReveal>
            <span className="inline-block px-4 py-2 text-xs font-medium tracking-[0.3em] uppercase text-primary border border-primary/30 rounded-full bg-primary/5 mb-6">
              Get in Touch
            </span>
            ...
            <div className="space-y-4 mb-8">
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <a href="mailto:contact@istegecb.in" className="text-foreground hover:text-primary transition-colors">
                    contact@istegecb.in
                  </a>
                </div>
              </div>
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-foreground">GEC Barton Hill, Thiruvananthapuram, Kerala</p>
                </div>
              </div>
              <div className="flex items-center gap-4">
                <div className="w-12 h-12 rounded-lg bg-primary/10 border border-primary/30 flex items-center justify-center">
