...
const TeamCard: React.FC<TeamCardProps> = ({ member, onClick }) => {
  return (
    <motion.div
      ...
      whileTap={{ scale: 0.98 }}
      transition={{ duration: 0.3 }}
      className="glass-card p-6 text-center group cursor-pointer min-w-[280px] flex-shrink-0 hover:border-primary/30 transition-colors"
    >
      ...
      <div className="flex justify-center gap-2">
        {member.whatsapp && (
          <div className="flex items-center gap-1 px-3 py-1.5 rounded-full bg-green-500/10 border border-green-500/30 text-green-400 text-xs">
        ...
        {member.phone && (
          <div className="flex items-center gap-1 px-3 py-1.5 rounded-full bg-primary/10 border border-primary/30 text-primary text-xs">
